...
//장르별 선곡
	...
	//1
	//2
	List<SoundTrackVO> top6=null;
	try{
		top6=dao.selectArtistTOP();
		...
		<div class='row' id='top50'>
			<% for(int i=0; i<6; i++){ %>
				<div class="col-lg-2 col-sm-6" id='art1'>
					<img src='../images/1.jpg'>
					<div style='float:left'>
					<span class='musicname2'>노래 이름</span><br>
					<span class='artist2'>가수이름</span>&nbsp;&nbsp;<span class='alname2'>앨범이름</span>
					</div>
				</div>
			<%} %>
		</div>
